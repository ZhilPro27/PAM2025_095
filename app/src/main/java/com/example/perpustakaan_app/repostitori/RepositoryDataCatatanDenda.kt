...
interface RepositoryDataCatatanDenda {
    ...
    suspend fun putCatatanDenda(id_denda: Int, dataCatatanDenda: DataCatatanDenda)
}
...
class JaringanRepositoryDataCatatanDenda(
    ...
    override suspend fun putCatatanDenda(id_denda: Int, dataCatatanDenda: DataCatatanDenda) = serviceApiCatatanDenda.putCatatanDenda(id_denda, dataCatatanDenda)
}